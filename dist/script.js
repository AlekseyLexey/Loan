...
/* harmony import */ var _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/slider/main-slider */ "./src/js/modules/slider/main-slider.js");
/* harmony import */ var _modules_slider_mini_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/slider/mini-slider */ "./src/js/modules/slider/mini-slider.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  showUpSlider.init();
  var modulesContentSlider = new _modules_slider_mini_slider__WEBPACK_IMPORTED_MODULE_4__["default"]({
  ...
  var forms = new _modules_form__WEBPACK_IMPORTED_MODULE_1__["default"]('form', 'form input[name=email]');
  forms.init();
});
...
/*#__PURE__*/
function () {
  function Difference(officerOld, officerNew, items) {
...
/*#__PURE__*/
function () {
  function Form(forms, emailInputs) {
  ...
  _createClass(Form, [{
    key: "validationEmail",
    value: function validationEmail(input) {
    ...
    key: "processingPostData",
    value: function processingPostData(url, data) {
      var res;
      return regeneratorRuntime.async(function processingPostData$(_context) {
        while (1) {
    ...
    value: function init() {
      ...
      this.emailInputs.forEach(function (item) {
        _this2.validationEmail(item);
      });
      this.mask();
      this.forms.forEach(function (item) {
        _this2.postData(item);
      });
    }
  }]);
...
/*#__PURE__*/
function () {
  function Player(triggers, modal) {
      ...
      try {
        ...
        if (this.slideIndex === 3) {
          setTimeout(function () {
            ...
            _this.hanson.style.visibility = 'visible';
...
function (_Slider) {
  ...
  function MiniSlider(sliderSelector, next, prev, activeClass, autoDrug, btns) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, sliderSelector, next, prev, activeClass, autoDrug, btns));
  }
      ...
      if (this.autoDrug) {
        ...
        this.btns.forEach(function (btn) {
          ...
          btn.addEventListener('mouseleave', function () {
            timerSlider = _this3.druggingSlide();
          });
        });
      }
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$autoDrug = _ref.autoDrug,
      autoDrug = _ref$autoDrug === void 0 ? false : _ref$autoDrug;
